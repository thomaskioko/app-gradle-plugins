...
- Record the public shape of every published artifact in a file kept alongside it, and fail the build when a change does not match. A change that would break someone else's code now has to be made on purpose, and shows up in review as a diff rather than as a surprise after release.
...
See [annotations.md](https://thomaskioko.github.io/app-gradle-plugins/codegen/annotations/), [examples.md](https://thomaskioko.github.io/app-gradle-plugins/codegen/examples/) sections 4, 7, and 8, and [architecture/consumer-contract.md](https://thomaskioko.github.io/app-gradle-plugins/codegen/architecture/consumer-contract/) for the full surface.
